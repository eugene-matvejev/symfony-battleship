 ...
 */
class Version20160630141451 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE players ADD email VARCHAR(25) NOT NULL, ADD password VARCHAR(40) NOT NULL, DROP name');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE players ADD name VARCHAR(100) NOT NULL COLLATE utf8_unicode_ci, DROP email, DROP password');
